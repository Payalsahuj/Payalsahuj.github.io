...
function Home(){
    ...
    return (
        ...
        width:'100%'
            ...
            <div style={{padding:'13% 4%',display:'flex',justifyContent:'space-evenly',alignItems:'center'}}>
           ...
           <div style={{width:'20%'}}>
            <div style={{position:'relative',backgroundColor:'#0277BD',borderRadius:'50%',width:'100px',height:'100px',margin:'auto',zIndex:'1'}}> 
            {/* <Link href={<Location/>}  >  */}
